...
If (DebugMode) {
  Gui, Add, GroupBox, ys Section w300 h440 vDebugBox, Debugging
  Gui, Add, ListView, xp+10 yp+15 w280 h410, Data|Value
}

;Console input field + button
GuiControlGet, GUIPos, Pos, ConsoleOutput
GUIPosY := GUIPosY + GUIPosH + 5
Gui, Add, GroupBox, x10 y%GUIPosY% w700 h50 vConsoleInputBox, Console Input
...
Gui, Add, Text, ys w150 vServerStatus cRed Bold, DOWN
